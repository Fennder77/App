...
customtkinter.set_default_color_theme("dark-yellow")
...
def add_task():
    ...
    customtkinter.CTkButton(window, text='Добавить', text_font='Arial 13 bold', command=lambda: add(task_text.get())).pack()
...
btn_add_task = customtkinter.CTkButton(root, text='Добавить задачу', text_font='Arial 13 bold', command=add_task)
